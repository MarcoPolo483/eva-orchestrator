# Copilot Brief – eva-agent

## Context

You are helping build **EVA 2.0**, a modular AI platform.
This brief is specifically about the **`eva-agent`** repo.
...
- `plans/minimum_readiness_matrix.md` (section for `eva-agent`)

## Role of this repo

Agentic orchestration layer (Semantic Kernel / AutoGen, etc.).
