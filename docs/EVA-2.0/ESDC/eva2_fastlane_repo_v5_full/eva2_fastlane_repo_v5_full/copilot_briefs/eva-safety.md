# Copilot Brief – eva-safety

    ## Context

    You are helping build **EVA 2.0**, a modular AI platform.
    This brief is specifically about the **`eva-safety`** repo.
    ...
    - `plans/minimum_readiness_matrix.md` (section for `eva-safety`)

    ## Role of this repo

    Centralized safety & policy checks (PII detection, content filters).
