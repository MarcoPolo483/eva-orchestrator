# Copilot Brief – eva-metering

    ## Context

    You are helping build **EVA 2.0**, a modular AI platform.
    This brief is specifically about the **`eva-metering`** repo.
    ...
    - `plans/minimum_readiness_matrix.md` (section for `eva-metering`)

    ## Role of this repo

    Usage and cost metering support.
